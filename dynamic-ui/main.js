...
const anchorTagsInsideDropdown = Array.from(
  document.querySelectorAll(".inside-dropdown")
);
...
dropdownParent.addEventListener("mouseleave", (e) => {
  if (
    ...
    anchorTagsInsideDropdown.includes(e.relatedTarget)
  ) {
    // Otherwise, when we exit towards dropdown-parent the menu does not close
    return;
  } else {
